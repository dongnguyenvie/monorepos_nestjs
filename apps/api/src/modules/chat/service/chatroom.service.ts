import { PREFIX_SOCKET } from '@noinghe/shared/dist/constants';
import { redisHelper } from '@noinghe/shared/dist/helpers/redis.helper';
import { RoomService } from '@modules/rooms/service/room.service';
import { UserService } from '@modules/users/service/user.service';
import { Injectable } from '@nestjs/common';
import { ReqUser } from '@shared/dtos';
import { MemoryCacheService } from '@shared/packages/memory-cache/memory-cache.service';
import { removeObjectEmpty } from '@shared/utils';
import dayjs from '@noinghe/shared/dist/libs/dayjs';
