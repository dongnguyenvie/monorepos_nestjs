import {
  ...
  EVENT_ROOM_SERVER,
  USER_ACCESSABLE,
} from '@noinghe/shared/dist/constants';
import { P2PEvent, CallEvent, JoinRoomEvent, ChatEvent, MessageType } from '@noinghe/shared/dist/events/sockets';
import { ClientStateEvent } from '@noinghe/shared/dist/events/sockets/client-state.event';
import { SyncRoomEvent } from '@noinghe/shared/dist/events/sync-room.event';
import { RoomService } from '@modules/rooms/service/room.service';
...
import { JwtService } from '@shared/jwt/my.jwt.service';
