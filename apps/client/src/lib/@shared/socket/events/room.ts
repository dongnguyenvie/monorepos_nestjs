...
import { P2PEvent, ClientStateEvent, CallEvent } from '@noinghe/shared/src/events/sockets';
import type { SocketID } from '$lib/types/socket';
import { MediaRequest, UserConnectionStatus } from '@noinghe/shared/src/enums';
import { get } from 'svelte/store';
import { JoinRoomEvent } from './join-room.event';
import { ClientShareable, type Client } from '$lib/types';
import type { UserConfig } from '@noinghe/shared/src/interfaces/room.interface';
import _ from 'underscore';
import { ChatEvent, MessageType } from '@noinghe/shared/src/events/sockets/chat.event';
